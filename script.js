...
const addNewCard = () => {
    ...
    //no need to define 'localStorage' 
...
//page will not refresh while reloading .The cards will exist
...
const loadExistingCards = () => {
    ...
    const taskCards = JSON.parse(getData); //parse will convert JSON object to javascript
     ...
     globalTaskData.map((taskData) => { //"forEach" also could've been used but forEach makes changes to the existing array & map creates a new array
